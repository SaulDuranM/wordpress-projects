...
<!-- Footer -->
<footer class="row color-contacto-2 footer">
    <div class="col-xs-12 footer-logo">
        <img src="<?=$dist_path;?>images/logo-avierto-gr.png" style="height:33px; width:160px;">
    </div>
    <div class="col-xs-12">
        <ul>
    ...
    <div class="col-xs-12">
        <a href="https://www.facebook.com/DeportivoAVIERTO/" target="_blank"><img class="footer-s" src="<?=$dist_path;?>images/face-gr.png"></a>
        <a href="https://twitter.com/aviertofutbol5" target="_blank"><img class="footer-s" src="<?=$dist_path;?>images/twit-gr.png"></a>
        <a href="https://www.instagram.com/aviertomx/" target="_blank"><img class="footer-s" src="<?=$dist_path;?>images/inst-gr.png"></a>
    </div>
    <div class="col-xs-12 footer-info">
        6394 - 6555, <a href="mailto:info@avierto.com.mx">info@avierto.com.mx,</a> Cda. de la paz 10, Escandón.
    </div>
    <div class="col-xs-12 copyright color-contacto-1">
